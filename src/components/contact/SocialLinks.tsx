...
const SocialLinks = () => {
  const socialPlatforms = [
    ...
    {
      name: 'WhatsApp',
      href: 'https://wa.me/7418950307',
      color: 'from-green-500 to-green-400',
      hoverColor: 'hover:from-green-400 hover:to-green-300',
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
    ...
    },
    {
      ...
      hoverColor: 'hover:from-gray-700 hover:to-gray-500 dark:hover:from-gray-100 dark:hover:to-gray-300',
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div className="flex space-x-4">
      {socialPlatforms.map((platform, index) => (
        <motion.a
          ...
          className={`relative p-4 rounded-xl bg-gradient-to-r ${platform.color} ${platform.hoverColor} text-white transition-all duration-300 group overflow-hidden`}
